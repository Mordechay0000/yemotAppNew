...
public class sipCustomAdapter extends RecyclerView.Adapter<sipCustomAdapter.MyCustomViewHolder> {

    private List<sipItem> itemList;
    private sipListOnItemActionClickListener listener;

    public sipCustomAdapter(List<sipItem> itemList) {
    ...
    public MyCustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_layout_sip, parent, false);
        return new MyCustomViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MyCustomViewHolder holder, int position) {
        sipItem item = itemList.get(position);
    ...
    public void setOnItemActionClickListener(sipListOnItemActionClickListener listener) {
    ...
    class MyCustomViewHolder extends RecyclerView.ViewHolder {
        ...
        sipListOnItemActionClickListener listener;
